...
class CCompiler:
    ...
    def compile(
        ...
        retaining their original path components.  That is, "foo/bar.c"
    ...
    def link(
        ...
        directory components, which means the linker will look in that
        specific directory rather than searching all the normal locations.

        'library_dirs', if supplied, should be a list of directories to
        search for libraries that were specified as bare library names
        (ie. no directory components).  These are on top of the system
