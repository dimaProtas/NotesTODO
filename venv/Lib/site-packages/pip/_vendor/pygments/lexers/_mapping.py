...
LEXERS = {
    ...
    'ComponentPascalLexer': ('pip._vendor.pygments.lexers.oberon', 'Component Pascal', ('componentpascal', 'cp'), ('*.cp', '*.cps'), ('text/x-components-pascal',)),
    ...
    'DockerLexer': ('pip._vendor.pygments.lexers.configs', 'Dockerfile', ('docker', 'dockerfile'), ('Dockerfile', '*.docker'), ('text/x-dockerfile-config',)),
