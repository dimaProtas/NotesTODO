        ...
        for path, method, view in view_endpoints:
            ...
            for k in components.keys():
                ...
                if components_schemas[k] == components[k]:
                    continue
                warnings.warn('Schema components "{}" has been overriden with a different value.'.format(k))
...
class AutoSchema(ViewInspector):
    ...
    def __init__(self, tags=None, operation_id_base=None, component_name=None):
        ...
        :param component_name: user-defined components's name. If empty, it will be deducted from the Serializer's class name.
        """
    ...
    def get_component_name(self, serializer):
        """
        Compute the components's name from the serializer.
        Raise an exception if the serializer's class name is "Serializer" (case-insensitive).
        """
        if self.component_name is not None:
            return self.component_name

        # use the serializer's class name as the components name.
    ...
    def _to_camel_case(self, snake_str):
        ...
        # We capitalize the first letter of each components except the first one
